...
class BeritaAcaraController extends Controller
{
    ...
    public function updateDetail($id,Request $request){
        ...
        $modelDetail->save();
        return redirect()->route('berita-acara.detail',['id'=>$modelDetail->id_berita_acara])->with('status', 'Data berhasil diupdate!');
    ...
    public function detail($id){
        ...
        ->get();
        // dd($items);
        return view('berita-acara.detail',compact('model','items'));
    }
    ...
    public function createDetail($id){
        ...
        return view('berita-acara.createDetail',compact('model','items','mahasiswa'));
    }
    ...
    public function editdetail($id){
        ...
        // dd($model);
        $mahasiswa = Mahasiswa::get();
        return view('berita-acara.editDetail',compact('model','mahasiswa'));
    }
    ...
    public function storeDetail($id,Request $request){
        ...
        $modelDetail->tgl_kedatangan = $request->hari;
        $modelDetail->save();
        return redirect()->route('berita-acara.detail',['id'=>$id])->with('status', 'Data berhasil ditambahkan!');
