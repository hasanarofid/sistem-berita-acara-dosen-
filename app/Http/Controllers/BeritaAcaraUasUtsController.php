...
class BeritaAcaraUasUtsController extends Controller
{
   //index
   public function index(){
    $model = BeritaAcara::where('jenis_ba','Berita Acara Uas Uts')->get();
    return view('berita-acara-uas-uts.index',compact('model'));
}
...
public function create(){
    ...
    return view('berita-acara-uas-uts.create',compact('fakultas','dosen','matkul','ruangan'));
}

//simpan
public function store(Request $request){
    $model = new BeritaAcara();
    $model->jenis_ba = 'Berita Acara Uas Uts';
...
public function detail($id){
    ...
    ->get();
    // dd($items);
    return view('berita-acara-uas-uts.detail',compact('model','items'));
}
...
public function createDetail($id){
    ...
    return view('berita-acara-uas-uts.createDetail',compact('model','items','mahasiswa'));
}
...
public function editdetail($id){
    ...
    // dd($model);
    $mahasiswa = Mahasiswa::get();
    return view('berita-acara-uas-uts.editDetail',compact('model','mahasiswa'));
}
