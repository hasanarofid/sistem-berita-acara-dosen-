...
@section('content')
      ...
      <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('berita-acara-formal-non.detail',['id'=>$model->id_berita_acara]) }}" class="btn btn-success pull-left">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card dosen">
                ...
                <div class="card-body">
                  <form action="{{ route('berita-acara-formal-non.update-detail',['id'=>$model->id]) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select class="form-control @error('id_mahasiswa') is-invalid @enderror" id="exampleFormControlSelect1" name="id_mahasiswa">
                            ...
                            <option value="{{ $item->id }}" {{ ($model->id_mahasiswa == $item->id) ? 'selected' : '' }}>
                                {{ $item->nim.' - '.$item->nama }}
                            </option>
                                  @endforeach
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" value="{{ $model->tgl_kedatangan }}" name="hari"  
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="waktu" value="{{ $model->waktu }}"
