...
@section('content')    
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-4">
            <a type="submit" href="{{ route('berita-acara.create-detail',['id'=>$model->id]) }}" class="btn btn-primary pull-right">Tambah</a>
                    ...
                    <table class="table">
                      ...
                      @forelse ($items as $index => $item)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('berita-acara.editdetail',['id'=> $item->id]) }}" class="btn btn-primary btn-sm">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <form action="{{ route('berita-acara.destroy', $item->id) }}" 
                                    method="post" 
                                    class="d-inline">
                                @csrf
                                @method('delete')
