...
@section('content')
      ...
      <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="{{ route('berita-acara.detail',['id'=>$model->id_berita_acara]) }}" class="btn btn-success pull-left">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card dosen">
                ...
                <div class="card-body">
                  <form action="{{ route('berita-acara.update-detail',['id'=>$model->id]) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                      <div class="col-md-12">
